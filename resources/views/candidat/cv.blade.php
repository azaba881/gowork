...
@media (max-width: 500px) {
 ...
 <div style="display: flex;flex-direction:column;justify-content:start;align-items:center;width:100%;">
  <!-- profil -->
  ...
  <div class="wrapper">
    <div class="intro">
      <div class="profile">
        <div class="photo">
          <img src="{{$travailleur->photo}}" style="width: 100px;height:100px;border-radius:50%">
        </div>
        <div class="bio">
      ...
      <div class="intro-section contact">
        <h4 class="">Contact infos</h4>
        <div class="info-section">
          <i class="fas fa-phone"></i>
          <span>{{$travailleur->numero}}</span>
        </div>
        <div class="info-section">
          <i class="fas fa-map-marker-alt"></i>
          <span>{{$travailleur->addresse}}</span>
        </div>
        <div class="info-section">
      ...
      <div class="detail-section edu">
		...
		@foreach ($etudes as $etude)
          <div class="timeline-block">
            <h1>{{$etude->grade}}</h1>
            <p>{{$etude->ecole}}</p>
            <time>{{$etude->debut}} - {{$etude->fin}}</time>
          </div>
        @endforeach
        </div>
      </div>
      ...
      <div class="detail-section edu">
		...
		@foreach ($experiences as $experience)
          <div class="timeline-block">
            ...
            <time>{{$experience->debut}} - {{$experience->fin}}</time>
          </div>
        @endforeach
        </div>
      </div>
          ...
          <ul class="pg-list">
			  ...
			  <li>
				...
				<div class="sb-skeleton">
				  <div class="skillbar" style="--pgbar-length: {{$skill->level}}%"></div>
				</div>
			  </li>
			  @endforeach            
          </ul>
