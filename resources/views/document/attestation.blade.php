    ...
    <style>
        ...
        <div class="row" style="width: 100%;">
            ...
            @else
                ...
                @foreach ($attestation as $attestation)
                <div class="col-lg-3 col-sm-3 text-center"><br><br><br>
                    <a href="{{$attestation->fichier}}" class="text-center monlien">
                        <i style="font-size: 150px;" class="fa fa-file monlien"></i>           
                    </a>
                    <h4 style="font-weight: 800;margin:10px;" >ATTESTATION {{$nombre++}}</h4>
                </div>
                @endforeach
            @endif
                ...
                <div class="form-input-content"> 
                    <div class="card login-form mb-0" >
                        <div class="card-body pt-5">
                         <form method="POST" class="mt-3 mb-5 login-input" action="{{ route('attestationstore') }}" enctype="multipart/form-data">
                        @csrf
