                ...
                <ul class="metismenu" id="menu">
                    <li>
                        <a href="{{route('home')}}" aria-expanded="false">
                            <span class="nav-text" ><i style="color: green" class="fa  fa-dashboard fa-fw" aria-hidden="true"></i> DASHBOARD</a></span>
                        </a>
                    </li> 
                    <li>
                        <a href="{{route('candidature')}}" aria-expanded="false">
                            <span class="nav-text"><i style="color: green" class="fa fa-th-large fa-fw" aria-hidden="true"></i> CANDIDATURE</a></span>
                        </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="{{route('profil')}}" aria-expanded="false">
                            <span class="nav-text"><i style="color: green" class="fa fa-user fa-fw" aria-hidden="true"></i> PROFIL</a></span>
                        </a>
                    </li> 
                    ...
                    <li>
                        <a aria-expanded="false" href="{{ route('logout') }}"
                                       ...
                                       <span class="nav-text"><i style="color: green" class="fa fa-power-off fa-fw menu-icon" aria-hidden="true"></i> DECONNEXION</a></span>
                                    </a>
