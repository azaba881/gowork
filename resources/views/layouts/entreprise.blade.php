        ...
        <div class="nk-sidebar">           
            <div class="nk-nav-scroll">
                <ul class="metismenu" id="menu"> 
                    <li>
                        <a href="{{route('entreprise')}}" aria-expanded="false">
                            <span class="nav-text"><i class="fa  fa-dashboard fa-fw" aria-hidden="true"></i> DASHBOARD</a></span>
                        </a>
                    </li> 
                    <li>
                        <a href="{{route('entreprisecandidature')}}" aria-expanded="false">
                            <span class="nav-text"><i class="fa fa-th-large fa-fw" aria-hidden="true"></i> CANDIDATURE</a></span>
                        </a>
                    </li>
                    <li>
                        <a href="{{route('entrepriseabonnement')}}" aria-expanded="false">
                            <span class="nav-text"><i class="fa fa-credit-card fa-fw" aria-hidden="true"></i> ABONNEMENT</a></span>
                        </a>
                    </li> 
                    <li>
                        <a href="{{route('entrepriseprofil')}}" aria-expanded="false">
                            <span class="nav-text"><i class="fa fa-user fa-fw" aria-hidden="true"></i> PROFIL</a></span>
                        </a>
                    </li>
                    <li>
                        <a href="{{route('demandeur')}}" aria-expanded="false">
